      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <ul className="hidden lg:flex space-x-8">
            <li>
              <NavLink to="/client/home" className={navLinkClass}>
                HOME
            ...
            <li>
              <NavLink to="/client/blog" className={navLinkClass}>
                BLOG
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-left"></span>
              </NavLink>
            </li>
            <li>
              <NavLink to="/client/packages" className={navLinkClass}>
                PACKAGES
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-left"></span>
              </NavLink>
            </li>
            <li>
              <NavLink to="/client/contact" className={navLinkClass}>
                CONTACT
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-left"></span>
              </NavLink>
            </li>
            <li>
              <NavLink to="/client/about" className={navLinkClass}>
                ABOUT
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-left"></span>
              </NavLink>
            </li>
